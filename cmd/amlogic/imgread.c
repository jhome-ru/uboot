...
static int do_image_read_dtb(struct cmd_tbl *cmdtp, int flag, int argc, char * const argv[])
{
    int iRet = 0;
...
static int do_image_read_kernel(struct cmd_tbl *cmdtp, int flag, int argc, char * const argv[])
{
...
static int do_image_read_res(struct cmd_tbl *cmdtp, int flag, int argc, char * const argv[])
{
    const char* const partName = argv[1];
    unsigned char* loadaddr = 0;
    int rc = 0;
...
static int do_image_read_pic(struct cmd_tbl *cmdtp, int flag, int argc, char * const argv[])
{
    const char* const partName = argv[1];
    unsigned char* loadaddr = 0;
    int rc = 0;
...
static struct cmd_tbl cmd_imgread_sub[] = {
...
static int do_image_read(struct cmd_tbl *cmdtp, int flag, int argc, char * const argv[])
{
	struct cmd_tbl *c;
...
//[imgread pic] logo bootup $loadaddr_misc
static int do_unpackimg(struct cmd_tbl *cmdtp, int flag, int argc, char * const argv[])
{
    unsigned char* loadaddr = 0;
    const AmlResImgHead_t* pResImgHead = NULL;
    unsigned itemIndex = 0;
