...
static int do_rsvmem_check(struct cmd_tbl *cmdtp, int flag, int argc,
		char *const argv[])
{
	unsigned int data = 0;
...
static int do_rsvmem_dump(struct cmd_tbl *cmdtp, int flag, int argc,
		char *const argv[])
{
	unsigned int data = 0;
	unsigned int bl31_rsvmem_size = 0;
...
static struct cmd_tbl cmd_rsvmem_sub[] = {
	U_BOOT_CMD_MKENT(check, 2, 0, do_rsvmem_check, "", ""),
	U_BOOT_CMD_MKENT(dump, 2, 0, do_rsvmem_dump, "", ""),
};
#endif

static int do_rsvmem(struct cmd_tbl *cmdtp, int flag, int argc, char *const argv[])
{
