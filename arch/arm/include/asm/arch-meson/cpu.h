...
/* Size of malloc() pool */
// v2019.01 #define CONFIG_SYS_MALLOC_LEN		(64*1024*1024)

/* dram */
#define PHYS_SDRAM_1_BASE					0x00000000UL
#define PHYS_SDRAM_1_SIZE					(CONFIG_DDR_SIZE << 20)
// v2019.01 #define CONFIG_SYS_SDRAM_BASE				PHYS_SDRAM_1_BASE
// v2019.01 #define CONFIG_SYS_INIT_SP_ADDR				(0x20000000)

#define CONFIG_SYS_TEXT_BASE		0x01000000 /*16MB rsv*/
// v2019.01 #define CONFIG_SYS_LOAD_ADDR		(PHYS_SDRAM_1_BASE + CONFIG_SYS_TEXT_BASE)

/* ? */
// v2019.01 #define CONFIG_SYS_CBSIZE		512
...
#define CONFIG_DTB_MEM_ADDR 0x10000000
