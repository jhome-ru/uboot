...
static void setup_net_chip(void)
{
	...
	/* hardware reset ethernet phy : gpioz5 connect phyreset pin*/
	clrbits_le32(PREG_PAD_GPIO3_EN_N, 1 << 5);
	clrbits_le32(PREG_PAD_GPIO3_O, 1 << 5);
	udelay(10000);
	setbits_le32(PREG_PAD_GPIO3_O, 1 << 5);
...
#error MTD Not supported now. need to make layout
...
int checkhw(char * name)
{
	...
	switch (b_id) {
		...
		// 	break;
		default:
			strcpy(loc_name, "axg_jethubj100_v1");
			break;
	}
